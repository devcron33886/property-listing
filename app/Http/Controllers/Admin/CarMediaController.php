...
class CarMediaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.carMedia.index', compact('carMedia'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.carMedia.create', compact('cars'));
    }
    ...
    public function store(StoreCarMediumRequest $request)
    {
        ...
        return redirect()->route('admin.car-media.index');
    }
    ...
    public function edit(CarMedium $carMedium)
    {
        ...
        return view('admin.carMedia.edit', compact('carMedium', 'cars'));
    }
    ...
    public function show(CarMedium $carMedium)
    {
        ...
        return view('admin.carMedia.show', compact('carMedium'));
    }
