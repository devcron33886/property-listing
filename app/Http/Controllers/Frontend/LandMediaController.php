...
class LandMediaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.landMedia.index', compact('landMedia'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.landMedia.create', compact('lands'));
    }
    ...
    public function store(StoreLandMediumRequest $request)
    {
        ...
        return redirect()->route('frontend.land-media.index');
    }
    ...
    public function edit(LandMedium $landMedium)
    {
        ...
        return view('frontend.landMedia.edit', compact('landMedium', 'lands'));
    }
    ...
    public function show(LandMedium $landMedium)
    {
        ...
        return view('frontend.landMedia.show', compact('landMedium'));
    }
