...
class HouseGalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.houseGalleries.index', compact('houseGalleries'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.houseGalleries.create', compact('houses'));
    }
    ...
    public function store(StoreHouseGalleryRequest $request)
    {
        ...
        return redirect()->route('frontend.house-galleries.index');
    }
    ...
    public function edit(HouseGallery $houseGallery)
    {
        ...
        return view('frontend.houseGalleries.edit', compact('houseGallery', 'houses'));
    }
    ...
    public function show(HouseGallery $houseGallery)
    {
        ...
        return view('frontend.houseGalleries.show', compact('houseGallery'));
    }
