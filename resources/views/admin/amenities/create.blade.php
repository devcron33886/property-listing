        ...
        <form method="POST" action="{{ route("admin.amenities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('parking') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="parking" id="parking" value="1" {{ old('parking', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('garage') ? 'is-invalid' : '' }}" type="number" name="garage" id="garage" value="{{ old('garage', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_age') ? 'is-invalid' : '' }}" type="text" name="building_age" id="building_age" value="{{ old('building_age', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('air_condition') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="air_condition" id="air_condition" value="1" {{ old('air_condition', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('bedding') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="bedding" id="bedding" value="1" {{ old('bedding', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('heating') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="heating" id="heating" value="1" {{ old('heating', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('internet') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="internet" id="internet" value="1" {{ old('internet', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('microwave') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="microwave" id="microwave" value="1" {{ old('microwave', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('smoking_allow') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="smoking_allow" id="smoking_allow" value="1" {{ old('smoking_allow', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('terrace') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="terrace" id="terrace" value="1" {{ old('terrace', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('wi_fi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="wi_fi" id="wi_fi" value="1" {{ old('wi_fi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('beach') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="beach" id="beach" value="1" {{ old('beach', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('property_video') ? 'is-invalid' : '' }}" type="text" name="property_video" id="property_video" value="{{ old('property_video', '') }}">
