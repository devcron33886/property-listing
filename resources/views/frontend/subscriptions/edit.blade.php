                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.subscriptions.update", [$subscription->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_from" id="start_from" value="{{ old('start_from', $subscription->start_from) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_at" id="end_at" value="{{ old('end_at', $subscription->end_at) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $subscription->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
