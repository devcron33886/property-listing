    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.car-media.update", [$carMedium->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="car_video">{{ trans('cruds.carMedium.fields.car_video') }}</label>
                            <input class="form-control" type="text" name="car_video" id="car_video" value="{{ old('car_video', $carMedium->car_video) }}">
