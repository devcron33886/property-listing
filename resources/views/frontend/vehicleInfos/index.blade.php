        ...
        <div class="col-md-12">
            @can('vehicle_info_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.vehicle-infos.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $vehicleInfo->id }}">
                                        ...
                                        <td>
                                            @can('vehicle_info_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.vehicle-infos.show', $vehicleInfo->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('vehicle_info_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.vehicle-infos.edit', $vehicleInfo->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('vehicle_info_delete')
                                                <form action="{{ route('frontend.vehicle-infos.destroy', $vehicleInfo->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('vehicle_info_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.vehicle-infos.massDestroy') }}",
