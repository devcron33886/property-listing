    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vehicle-infos.update", [$vehicleInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="steeling" id="steeling" value="{{ old('steeling', $vehicleInfo->steeling) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="air_bag" id="air_bag" value="1" {{ $vehicleInfo->air_bag || old('air_bag', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="audio_input" id="audio_input" value="1" {{ $vehicleInfo->audio_input || old('audio_input', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="bluetooth" id="bluetooth" value="1" {{ $vehicleInfo->bluetooth || old('bluetooth', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="heated_seats" id="heated_seats" value="1" {{ $vehicleInfo->heated_seats || old('heated_seats', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="fm_radio" id="fm_radio" value="1" {{ $vehicleInfo->fm_radio || old('fm_radio', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="usb_input" id="usb_input" value="1" {{ $vehicleInfo->usb_input || old('usb_input', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="gps_navigation" id="gps_navigation" value="1" {{ $vehicleInfo->gps_navigation || old('gps_navigation', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="sunroof" id="sunroof" value="1" {{ $vehicleInfo->sunroof || old('sunroof', 0) === 1 ? 'checked' : '' }}>
