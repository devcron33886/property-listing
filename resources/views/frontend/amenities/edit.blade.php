                    ...
                    <form method="POST" action="{{ route("frontend.amenities.update", [$amenity->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="parking" id="parking" value="1" {{ $amenity->parking || old('parking', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="garage" id="garage" value="{{ old('garage', $amenity->garage) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="building_age" id="building_age" value="{{ old('building_age', $amenity->building_age) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="air_condition" id="air_condition" value="1" {{ $amenity->air_condition || old('air_condition', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="bedding" id="bedding" value="1" {{ $amenity->bedding || old('bedding', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="heating" id="heating" value="1" {{ $amenity->heating || old('heating', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="internet" id="internet" value="1" {{ $amenity->internet || old('internet', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="microwave" id="microwave" value="1" {{ $amenity->microwave || old('microwave', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="smoking_allow" id="smoking_allow" value="1" {{ $amenity->smoking_allow || old('smoking_allow', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="terrace" id="terrace" value="1" {{ $amenity->terrace || old('terrace', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="balcony" id="balcony" value="1" {{ $amenity->balcony || old('balcony', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="wi_fi" id="wi_fi" value="1" {{ $amenity->wi_fi || old('wi_fi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="beach" id="beach" value="1" {{ $amenity->beach || old('beach', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="property_video" id="property_video" value="{{ old('property_video', $amenity->property_video) }}">
