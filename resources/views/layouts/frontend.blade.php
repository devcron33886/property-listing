                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('advert_access')
                                        <a class="dropdown-item" href="{{ route('frontend.adverts.index') }}">
                                            {{ trans('cruds.advert.title') }}
                                        </a>
                                    @endcan
                                    @can('plan_access')
                                        <a class="dropdown-item" href="{{ route('frontend.plans.index') }}">
                                    ...
                                    @endcan
                                    @can('loaction_access')
                                        <a class="dropdown-item" href="{{ route('frontend.loactions.index') }}">
                                            {{ trans('cruds.loaction.title') }}
                                        </a>
                                    @endcan
                                    @can('electronic_access')
                                        <a class="dropdown-item" href="{{ route('frontend.electronics.index') }}">
                                    ...
                                    @endcan
                                    @can('house_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.houses.index') }}">
                                    ...
                                    @can('vehicle_info_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.vehicle-infos.index') }}">
